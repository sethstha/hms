import Root from '../file-drop-zone/file-drop-zone.svelte';
import Trigger from '../file-drop-zone/file-drop-zone-trigger.svelte';
import Textarea from '../file-drop-zone/file-drop-zone-textarea.svelte';
import type { FileDropZoneRootProps, FileRejectedReason } from '../file-drop-zone/types';
