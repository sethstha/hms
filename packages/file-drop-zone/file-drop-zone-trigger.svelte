<script lang="ts">
	...
	import { useFileDropZoneTrigger } from '../file-drop-zone/file-drop-zone.svelte.js';
	import { displaySize } from '../file-drop-zone/index.js';
	import type { FileDropZoneTriggerProps } from '../file-drop-zone/types.js';
