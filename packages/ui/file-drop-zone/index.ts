import Root from '../ui/file-drop-zone/file-drop-zone.svelte';
import Trigger from '../ui/file-drop-zone/file-drop-zone-trigger.svelte';
import Textarea from '../ui/file-drop-zone/file-drop-zone-textarea.svelte';
import type { FileDropZoneRootProps, FileRejectedReason } from '../ui/file-drop-zone/types';
