<script lang="ts">
	...
	import { useFileDropZoneTrigger } from '../ui/file-drop-zone/file-drop-zone.svelte.js';
	import { displaySize } from '../ui/file-drop-zone/index.js';
	import type { FileDropZoneTriggerProps } from '../ui/file-drop-zone/types.js';
