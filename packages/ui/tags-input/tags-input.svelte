<script lang="ts">
	...
	import type { TagsInputProps } from '../ui/tags-input/types';
	import TagsInputTag from '../ui/tags-input/tags-input-tag.svelte';
	import TagsInputSuggestion from '../ui/tags-input/tags-input-suggestion.svelte';
