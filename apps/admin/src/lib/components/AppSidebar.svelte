<script lang="ts">
      ...
      items: [
        {
          ...
          href: adminRoutes.organizations.root,
        },
        {
          label: "Add Organization",
          icon: "M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z",
          href: adminRoutes.organizations.new,
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          href: adminRoutes.permissions.root,
        },
        {
          label: "Add Permission",
          icon: "M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z",
          href: adminRoutes.permissions.new,
        },
      ],
    },
    {
  ...
  function isActive(href: string): boolean {
    if (href === adminRoutes.dashboard) return page.url.pathname === adminRoutes.dashboard;
